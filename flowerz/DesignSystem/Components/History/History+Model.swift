...
// MARK: - Components.History + Model

/// Карточка истории ухода
extension Components.History {
...
// MARK: - Operation.Kind + Color
/// Возвращает цвет для операции по уходу

extension Components.History.Model.Operation.Kind {
