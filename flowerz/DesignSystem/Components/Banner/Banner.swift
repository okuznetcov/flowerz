...
// MARK: - Components + Banner
// ✅ UniversalTableView — BannerItem
// ✅ Eureka — InputRow
...
extension Components {
    ...
    public final class Banner: UIView {
        ...
        /// Модель данных, на основе которой будет отрисован баннер
        ...
        private func makeConstraints(with style: Style) {
            ...
            subTitleLabel.snp.makeConstraints {
                ...
                $0.bottom.lessThanOrEqualTo(card).inset(Sizes.textVerticalOffset)
            }
