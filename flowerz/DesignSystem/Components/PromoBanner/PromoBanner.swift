...
// MARK: - Components + PromoBanner
// ✅ UniversalTableView — PromoBannerItem
// ✅ Eureka - PromoBannerRow
...
extension Components {
    ...
    public final class PromoBanner: UIView {
        ...
        private func setup(using model: Model) {
            ...
            // Отключаем анимации и убираем все сабьвбю
        ...
        private func makeConstraints(with model: Model) {
            ...
            shadowView.snp.removeConstraints()
            ...
            button.snp.makeConstraints { make in
                ...
                // Размещаем кнопку согласно ее расположению из модели
